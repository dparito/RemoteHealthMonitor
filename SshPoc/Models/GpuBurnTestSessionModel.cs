...
namespace SshPoc
{
    public class GpuBurnTestSessionModel : ISshModel, INotifyPropertyChanged, IDisposable
    {
        ...
        public GpuBurnTestSessionModel()
        {
        ...
        public GpuBurnTestSessionModel(string username, string password, string ipaddress, int port)
        {
            _sessionId = Guid.NewGuid().ToString();
            Username = username;
            Password = password;
                    ...
                    if (_sshReader != null)
                    {
                        ...
                        while ((line = _sshReader.ReadLine()) != null)
                        {
                            ...
                            if (line.Contains("Result = "))
                            {
                                ...
                                if (result == _configParser.Limits.GpuBurn.TestLimit.ToString())
                                {
