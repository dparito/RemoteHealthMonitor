...
namespace SshPoc
{
    public class WifiFloodTestSessionModel : ISshModel, INotifyPropertyChanged, IDisposable
    {
        ...
        public WifiFloodTestSessionModel()
        {
        ...
        public WifiFloodTestSessionModel(string username, string password, string ipaddress, int port)
        {
            _sessionId = Guid.NewGuid().ToString();
            Username = username;
            Password = password;
