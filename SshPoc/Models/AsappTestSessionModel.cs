...
namespace SshPoc
{
    public class AsappTestSessionModel : ISshModel, INotifyPropertyChanged, IDisposable
    {
        ...
        public AsappTestSessionModel(string username, string password, string ipaddress, int port)
        {
            _sessionId = Guid.NewGuid().ToString();
            Username = username;
            Password = password;
